...
import { InputWrapper,
  IconWrapper,InputGroup, AdminSignInContainer, FormContainer, InputField, SubmitButton } from "../styles/TeacherLoginStyles";
...
const TeacherLogin = () => {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:4000/api/auth/teacher/login", {
        email,
        password,
      });
    ...
    <AdminSignInContainer>
      ...
      <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            ...
            <a href="/admin-register" className="text-blue-600 ml-1 hover:underline">
              Sign Up
            </a>
          </p>
        </div>
