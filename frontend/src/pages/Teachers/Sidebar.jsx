...
import { BsGraphUp, BsPeople, BsPerson, BsFileText, BsBook, BsGraphDown, BsCalendar, BsGear, BsChatDots, BsCalendarEvent, BsQuestionSquare, BsYoutube, BsCalendarDay, BsFileSpreadsheetFill, BsCardList } from 'react-icons/bs';
  ...
  return (
    <SidebarContainer style={{ width: isOpen ? '250px' : '80px' }}>
      ...
      <SidebarNav>
        ...
        <SidebarNavItem>
          <SidebarIcon><BsCalendarDay /></SidebarIcon>
          <StyledLink to="/teacher/timetable">Timetable</StyledLink>
        </SidebarNavItem>
        
        <SidebarNavItem>
          <SidebarIcon><BsYoutube /></SidebarIcon>
          <StyledLink to="/teacher/video">Video Lectures</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsBook /></SidebarIcon>
          <StyledLink to="/teacher/pastpaper">Past Paper</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsFileSpreadsheetFill /></SidebarIcon>
          <StyledLink to="/teacher/attendance">Attendance</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsCardList/></SidebarIcon>
          <StyledLink to="/teacher/grade">Grading</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
